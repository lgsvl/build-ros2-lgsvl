...
('meta-webos',                40, 'git://github.com/webosose/meta-webosose.git',            'branch=master,commit=c01e75b', ''),
...
('meta-ros2-lgsvl',           60, 'git://github.com/lgsvl/meta-ros2-lgsvl.git',             'branch=devel,commit=18f20ba', ''),
]
